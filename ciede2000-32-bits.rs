...
fn ciede2000(l1: f32, a1: f32, b1: f32, l2: f32, a2: f32, b2: f32) -> f32 {
    ciede2000_with_parameters(l1, a1, b1, l2, a2, b2, 1.0f32, 1.0f32, 1.0f32, false)
}

// The classic CIE ΔE2000 implementation, which operates on two L*a*b* colors, and returns their difference.
// "l" ranges from 0 to 100, while "a" and "b" are unbounded and commonly clamped to the range of -128 to 127.
fn ciede2000_with_parameters(l1: f32, a1: f32, b1: f32, l2: f32, a2: f32, b2: f32, kl: f32, kc: f32, kh: f32, canonical: bool) -> f32 {
